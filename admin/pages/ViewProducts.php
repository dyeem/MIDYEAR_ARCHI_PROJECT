        ...
        <div class="container-fluid" >
            <div class="row">
                <div class="container-fluid body">
                    <div class="row box-area d-flex justify-content-center align-items-center">
                        <!-- LEFT SIDE -->
                        <div class="col-lg-6 col-md-4 col-sm-12 rounded-5 left-box ">
                            <div class="name">
                        ...
                        <!-- right box -->
                        <div class="col-lg-6 col-md-4 col-sm-12 rounded-5 right-box">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-end">
                                    <a href="../../product.php">
                                        <button class="btn fs-3" style="color: #CCCCCC;">
                                            X
                                        </button>
                                    </a>
                                </div>
                            ...
                            <div class="row align-items-center d-flex justify-content-center">
                                <div class="col-lg-12">
                                    <p class="productname" style="color: #CCCCCC;">
                                        <?=$product ['name']; ?>
                                    </p>
                                </div>
                            </div>
